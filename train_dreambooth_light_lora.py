...
def main(args):
    ...
    for i, (attn_processor_name, attn_processor) in enumerate(unet.attn_processors.items()):
        ...
        attn_module.to_q.set_lora_layer(
            LoRALinearLayer(
                ...
                rank=args.rank, down_dim=args.down_dim, up_dim=args.up_dim, is_train=True,
            )
        )
            ...
            if args.validation_prompt is not None and epoch % args.validation_epochs == 0 and epoch > 0:
                ...
                if args.validation_images is None:
                    ...
                    for image in args.validation_images:
                        ...
                        images.append(image)
                for i, image in enumerate(images):
                    image.save("aigc_samples/validation_epoch%d_%d.jpg" % (epoch, i))
    ...
    if accelerator.is_main_process:
        #TODO：convert user-defined lora to a standard lora.
        ...
        if text_encoder is not None and args.train_text_encoder:
            ...
            text_encoder_lora_layers = text_encoder_lora_state_dict(text_encoder, patch_mlp=args.patch_mlp)
        else:
